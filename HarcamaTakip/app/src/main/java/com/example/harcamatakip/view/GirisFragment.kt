...
import com.example.harcamatakip.adapter.RecyclerCardAdapter
import com.example.harcamatakip.databinding.FragmentGirisBinding
...
import com.example.harcamatakip.service.CurrencyAPI
...
class GirisFragment : Fragment() , RecyclerCardAdapter.Listener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sharedPreferences = context?.getSharedPreferences("com.example.harcamatakip", Context.MODE_PRIVATE)!!
